 ...
 * @author user
 */
public class EtudiantFiliereNiveauTableModel extends AbstractTableModel {
    private final List<Etudiant> etudiant;

    EtudiantFiliereNiveauTableModel( String niveau , String fil) {
    EtudiantServiceImp etudiantservice = new EtudiantServiceImp();
    etudiant = etudiantservice.listEtudiant(niveau, fil);
    }
